...
export class Dtp extends Instantiable {
    ...
    public static async getInstance(config: InstantiableConfig): Promise<Dtp> {
        ...
        config.nevermined.keeper.agreementStoreManager.addTemplate(dtp.accessProofTemplate.address, dtp.accessProofTemplate)
        ...
        config.nevermined.assets.servicePlugin['access-proof'] = new AccessProofServicePlugin(dtp, config.nevermined)
